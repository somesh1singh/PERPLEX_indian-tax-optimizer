...
Quick Terminal Command to Create Files Locally
Alternatively, you can run this single command in your terminal to generate all three files at once in your project folder:
cat > README.md << 'EOF'
